...
import MuzychenkoPopup from "../../../../Components/Muzychenko/MuzychenkoPopup/MuzychenkoPopup";
import CreateKategoriiPopup from "./Popups/CreateKategoriiPopup";
import EditKategoriiPopup from "./Popups/EditKategoriiPopup";
...
const MuzychenkoKategorii = () => {
    ...
    const [editedCategory, setEditedCategory]=useState<Kategorii|null>(null)

    return (
        <div style={{width:'100%'}}>

            {createPopupOpened && <CreateKategoriiPopup
            open={createPopupOpened}
            onClose={()=>setCreatePopupOpened(false)}
            onCreate={(newCategory)=>onCreate(newCategory)}
            />}

            {editedCategory !== null && <EditKategoriiPopup
